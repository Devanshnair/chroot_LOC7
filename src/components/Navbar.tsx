...
import { Menu, X, Home, FileText, Map, User, User2Icon, LogOutIcon, AlertTriangle, 
         MessageCircle, Siren, FlagTriangleRight, ShieldCheck, Phone, 
         ChartNetwork} from "lucide-react";
...
const officerNavLinks: NavLink[] = [
  ...
  { path: "/performance", label: "Performance", icon: <ChartNetwork className="h-5 w-5" /> },
];
